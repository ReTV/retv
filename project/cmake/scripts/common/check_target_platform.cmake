...
function(check_install_permissions install_dir have_perms)
  ...
  set(${have_perms} TRUE)
  execute_process(COMMAND ${CMAKE_COMMAND} -E make_directory ${install_dir}/lib/retv
                  COMMAND ${CMAKE_COMMAND} -E make_directory ${install_dir}/share/retv
                  COMMAND ${CMAKE_COMMAND} -E touch ${install_dir}/lib/retv/.cmake-inst-test ${install_dir}/share/retv/.cmake-inst-test
  ...
  if(EXISTS ${install_dir}/lib/retv/.cmake-inst-test OR EXISTS ${install_dir}/share/retv/.cmake-inst-test)
    file(REMOVE ${install_dir}/lib/retv/.cmake-inst-test ${install_dir}/share/retv/.cmake-inst-test)
  endif()
endfunction()
